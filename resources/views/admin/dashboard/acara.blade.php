    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="container-fluid">
                ...
                @endif
                <form action="/acara/upload/proses" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card">
                        <div class="card-header">
                            <div class="callout callout-info">
                                <h5>Informasi</h5>
                                <p>
                                    Unggah File LPJ Kegiatan yang akan diajukan. Ukuran maksimum file: 25 MB.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Unggah File LPJ Kegiatan </h3>
                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" autocomplete="new-password" minlength="4"
                                            ...
                                            placeholder="Unggah file LPJ yang akan diajukan">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1"
                                                value="option1">
                                            <label class="form-check-label" for="inlineCheckbox1">File LPJ RKAT</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="inlineCheckbox2"
                                                value="option2">
                                            <label class="form-check-label" for="inlineCheckbox2">File LPJ
                                                Non-RKAT</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="File">File LPJ</label>
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control-file" accept="application/pdf"
                                            data-val="true" data-val-required="The File field is required." id="file"
                                            name="file">
                                    </div>
                                </div>
                                {{-- <div class="form-group row">
