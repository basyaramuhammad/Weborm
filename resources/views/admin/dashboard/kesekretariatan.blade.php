...
@section('content')
    <section class="section">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="callout callout-info">
                        <h5>Informasi</h5>
                        <p>
                            Unggah Dokumen Proposal Kegiatan yang akan diajukan. Ukuran maksimum dokumen: 25 MB.
                        </p>
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Unggah Dokumen Proposal Kegiatan </h3>
                </div>
                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="/Sign/Create"
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" autocomplete="new-password" minlength="4"
                                    ...
                                    id="PasswordSertifikat" name="PasswordSertifikat" placeholder="Masukan nama orgasisasi">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="PasswordSertifikat">Nama Kegiatan Organisasi</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" autocomplete="new-password" minlength="4"
                                    data-val="true" data-val-required="The PasswordSertifikat field is required."
                                    id="PasswordSertifikat" name="PasswordSertifikat"
                                    placeholder="Unggah dokumen proposal yang akan diajukan">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label" for="Dokumen">Proposal</label>
                            <div class="col-sm-10">
